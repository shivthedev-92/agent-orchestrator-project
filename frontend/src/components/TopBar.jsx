...
export default function TopBar({
  ...
  onSave, onNew, onDelete, onSwitch, onRename, onHome, onNewAgent,
}) {
  ...
  return (
    <header className="topbar">
      ...
      {onHome && (
        <button className="brand-home" onClick={onHome} title="Back to Projects">
      ...
      <div className="topbar-actions">
        ...
        <div className="tb-dropdown-wrap">
          <button className="tb-btn" onClick={() => setNewOpen((o) => !o)} title="Create new">
            ...
            New
            <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" style={{ marginLeft: 2 }}><path d="M6 9l6 6 6-6"/></svg>
          </button>
          {newOpen && (
            <div className="tb-dropdown">
              <div className="tb-dd-item" onClick={() => { setNewOpen(false); onNewAgent?.(); }}>
                <svg width="14" height="14" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none"><circle cx="12" cy="12" r="3"/><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"/></svg>
                New Agent
              </div>
              <div className="tb-dd-item" onClick={() => { setNewOpen(false); onNew?.(); }}>
                <svg width="14" height="14" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none"><rect x="3" y="3" width="18" height="18" rx="3"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>
                New Project
              </div>
            </div>
          )}
